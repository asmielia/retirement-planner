...
describe('Strategy Parameter', () => {
  ...
  it('O2: optimize strategy has cash floor (2 months expenses)', () => {
    ...
    // grossEstimate rises to ~49351 to cover tax on RRSP top-up (~95323)
    // cashFloor = (grossEstimate/12) * 2 ≈ 8225
    // savWd = grossEstimate ≈ 49351 (all from cash since portfolioNeed = grossEstimate)
    expect(row.savWd).toBeCloseTo(49351, 0);
